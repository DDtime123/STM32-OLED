...
//IO2¨´¡Á¡Âo¡¥¨ºy	 
#define IIC_SCL3    PBout(6) //SCL
#define IIC_SDA3    PBout(7) //SDA	 
#define READ_SDA3   PBin(7)  //¨º?¨¨?SDA 


//IIC?¨´¨®D2¨´¡Á¡Âo¡¥¨ºy
void IIC_Init3(void);                //3?¨º??¡¥IIC¦Ì?IO?¨²				 
void IIC_Start3(void);				//¡¤¡é?¨ªIIC?a¨º?D?o?
void IIC_Stop3(void);	  			//¡¤¡é?¨ªIIC¨ª¡ê?1D?o?
